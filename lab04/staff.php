...
<body>
    ...
    <h2 align =left>รายชื่อคณะกรรมการ </h2>
    <h3 align =left>เพิ่มรายชื่อ | <a href='newstaff.php'><span class='glyphicon glyphicon-upload'></span></a></h3>
        <form  align =left action="#" method="post">
            <input type="text" name="kw" placeholder="Enter staff name" value="" size=50>
        ...
        if ($result->num_rows == 0) {
            ...
            while($row = $result->fetch_object()){ 
                ...
                $table.= "<td>";
                $table.= "<center><a href='editstaff.php?id=$row->id'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a></center>";
                $table.= "</td>";
                $table.= "<td>";
                $table.= "<center><a href='deletestaff.php?id=$row->id'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a></center>";
                $table.= "</td>";
                $table.= "</tr>";
            }
